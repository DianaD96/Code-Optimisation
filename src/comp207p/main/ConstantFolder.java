...
public class ConstantFolder
{
	...
	**/
	...
	private int getPrevInt(InstructionHandle handle, InstructionList instList, ConstantPoolGen cpgen)
	{
		...
		if (handle.getInstruction() instanceof D2I)
		{
		...
		if (handle.getInstruction() instanceof F2I)
		{
		...
		if (handle.getInstruction() instanceof L2I)
		{
	...
	private long getPrevLong(InstructionHandle handle, InstructionList instList, ConstantPoolGen cpgen)
	{
		...
		if (handle.getInstruction() instanceof F2L)
		{
		...
		if (handle.getInstruction() instanceof D2L)
		{
		...
		if (handle.getInstruction() instanceof I2L)
		{
	...
	private double getPrevDouble(InstructionHandle handle, InstructionList instList, ConstantPoolGen cpgen)
	{
		...
		if (handle.getInstruction() instanceof F2D)
		{
		...
		if (handle.getInstruction() instanceof L2D)
		{
	...
	private float getPrevFloat(InstructionHandle handle, InstructionList instList, ConstantPoolGen cpgen)
	{
		...
		if (handle.getInstruction() instanceof D2F)
		{
		...
		if (handle.getInstruction() instanceof L2F)
		{
	...
	{
		if (handle.getInstruction() instanceof IFGE || handle.getInstruction() instanceof IFLE || handle.getInstruction() instanceof IFNE)
		{
